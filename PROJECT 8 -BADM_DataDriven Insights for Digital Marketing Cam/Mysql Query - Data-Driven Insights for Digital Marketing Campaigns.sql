...
AVG(AVERAGE_ENGAGEMENT_TIME_PER_SESSION) AS AVG_ENGAGEMENT_TIME,
...
WITH DEMOGRAPHICS AS (
    SELECT 
        C.COUNTRY, 
        C.USERS AS COUNTRY_USERS, C.NEW_USERS AS COUNTRY_NEW_USERS, 
        C.ENGAGED_SESSIONS AS COUNTRY_ENGAGED_SESSIONS, C.ENGAGEMENT_RATE AS COUNTRY_ENG_RATE, 
        C.TOTAL_REVENUE AS COUNTRY_REVENUE,

        A.AGE_GROUP, 
        A.USERS AS AGE_USERS, A.NEW_USERS AS AGE_NEW_USERS, 
        A.ENGAGED_SESSIONS AS AGE_ENGAGED_SESSIONS, A.ENGAGEMENT_RATE AS AGE_ENG_RATE, 
        A.TOTAL_REVENUE AS AGE_REVENUE,

        I.INTREST_CATEGORY, 
        I.USERS AS INTEREST_USERS, I.NEW_USERS AS INTEREST_NEW_USERS, 
        I.ENGAGED_SESSIONS AS INTEREST_ENGAGED_SESSIONS, I.ENGAGEMENT_RATE AS INTEREST_ENG_RATE, 
        I.TOTAL_REVENUE AS INTEREST_REVENUE,

        G.GENDER, 
        G.USERS AS GENDER_USERS, G.NEW_USERS AS GENDER_NEW_USERS, 
        G.ENGAGED_SESSIONS AS GENDER_ENGAGED_SESSIONS, G.ENGAGEMENT_RATE AS GENDER_ENG_RATE, 
        G.TOTAL_REVENUE AS GENDER_REVENUE
    FROM DEMOGRAPHIC_COUNTRY C
    LEFT JOIN DEMOGRAPHIC_AGE A ON C.COUNTRY = A.AGE_GROUP
    LEFT JOIN DEMOGRAPHIC_INTRESTS I ON C.COUNTRY = I.INTREST_CATEGORY
    LEFT JOIN DEMOGRAPHIC_GENDER G ON C.COUNTRY = G.GENDER
)
SELECT 
    COUNTRY, AGE_GROUP, INTREST_CATEGORY, GENDER,
    COUNTRY_USERS, AGE_USERS, INTEREST_USERS, GENDER_USERS,
    COUNTRY_NEW_USERS, AGE_NEW_USERS, INTEREST_NEW_USERS, GENDER_NEW_USERS,
    COUNTRY_ENGAGED_SESSIONS, AGE_ENGAGED_SESSIONS, INTEREST_ENGAGED_SESSIONS, GENDER_ENGAGED_SESSIONS,
    COUNTRY_ENG_RATE, AGE_ENG_RATE, INTEREST_ENG_RATE, GENDER_ENG_RATE,
    COUNTRY_REVENUE, AGE_REVENUE, INTEREST_REVENUE, GENDER_REVENUE
FROM DEMOGRAPHICS
ORDER BY COUNTRY_REVENUE DESC;


SELECT 
  'Country' AS DEMOGRAPHIC_TYPE,
  COUNTRY AS DEMOGRAPHIC_VALUE,
  USERS,
  NEW_USERS,
  ENGAGED_SESSIONS,
  ENGAGEMENT_RATE,
  ENGAGED_SESSION_PER_USER,
...
SELECT 
  'Interest' AS DEMOGRAPHIC_TYPE,
  INTREST_CATEGORY AS DEMOGRAPHIC_VALUE,
  USERS,
  NEW_USERS,
  ENGAGED_SESSIONS,
  ENGAGEMENT_RATE,
...
DESCRIBE DEMOGRAPHIC_INTRESTS;
DESCRIBE DEMOGRAPHIC_GENDER;

ALTER TABLE DEMOGRAPHIC_GENDER CHANGE COLUMN AVAERAGE_ENGAGEMENT_TIME AVERAGE_ENGAGEMENT_TIME INT;
ALTER TABLE DEMOGRAPHIC_INTRESTS CHANGE COLUMN AVAERAGE_ENGAGEMENT_TIME AVERAGE_ENGAGEMENT_TIME INT;
ALTER TABLE DEMOGRAPHIC_AGE CHANGE COLUMN AVAERAGE_ENGAGEMENT_TIME AVERAGE_ENGAGEMENT_TIME INT;
